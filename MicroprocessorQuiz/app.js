// ============================================
//  MICROPROCESSOR QUIZ — APPLICATION LOGIC
// ============================================
...
(() => {
    ...
    function renderQuestion() {
        ...
        // Type badge
        if (q.type === 'code') {
            qTypeBadge.innerHTML = `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg> Specs & Code`;
        ...
        if (q.code) {
            ...
            codeLabel.textContent = 'Reference Information';
    ...
    function showResults() {
        ...
        // Title
        if (pct === 100) { resTitle.textContent = '🏆 Perfect Score!'; resSub.textContent = 'Hardware master! Flawless run.'; }
        else if (pct >= 85) { resTitle.textContent = '🌟 Outstanding!'; resSub.textContent = 'You really know your microprocessors!'; }
        ...
        else if (pct >= 30) { resTitle.textContent = '📖 Keep Learning!'; resSub.textContent = 'Practice your architectures and histories.'; }
    ...
    function buildCategoryBreakdown() {
        ...
        const colors = {
            ...
            'Processors': '#22d3ee',
            'Memory': '#fb923c',
            'Specifications': '#facc15',
            'Interfacing & Buses': '#f472b6',
            'Features': '#4ade80'
        };
