// ============================================
//  COMPUTER NETWORKS QUIZ — APPLICATION LOGIC
// ============================================
...
(() => {
    ...
    function renderQuestion() {
        ...
        // Code panel (not used for this quiz but kept for structure)
    ...
    function showResults() {
        ...
        // Title
        if (pct === 100) { resTitle.textContent = '🏆 Perfect Score!'; resSub.textContent = 'Network guru! Flawless run on all topics.'; }
        else if (pct >= 85) { resTitle.textContent = '🌟 Outstanding!'; resSub.textContent = 'Excellent knowledge of Computer Networks!'; }
        else if (pct >= 70) { resTitle.textContent = '👏 Great Job!'; resSub.textContent = 'Strong fundamentals — keep sharpening your networking skills.'; }
        else if (pct >= 50) { resTitle.textContent = '👍 Not Bad!'; resSub.textContent = 'Decent, but review the topics you missed.'; }
        else if (pct >= 30) { resTitle.textContent = '📖 Keep Learning!'; resSub.textContent = 'Revisit the OSI model, topologies, and IP addressing.'; }
    ...
    function buildCategoryBreakdown() {
        ...
        const colors = {
            'Fundamentals': '#06b6d4',
            'Network Types': '#f59e0b',
            'OSI Model': '#a78bfa',
            'Transmission Media': '#f472b6',
            'Network Topology': '#4ade80',
            'LAN Devices': '#22d3ee',
            'IP Addressing': '#facc15'
        };
